...
def _bn(channel):
    # FrozenBatchNorm
    return nn.BatchNorm2d(channel, use_batch_statistics=False, affine=False)
...
class Bottleneck(nn.Cell):
    ...
    def __init__(self, inplanes, planes, stride=1, downsample=None, groups=1,
        ...
        self.bn3 = _bn(planes * self.expansion)
        self.relu = nn.ReLU()
        self.downsample = downsample
        self.stride = stride
...
def wide_resnet50_2(pretrained='', **kwargs):
...
def wide_resnet101_2(pretrained='', **kwargs):
